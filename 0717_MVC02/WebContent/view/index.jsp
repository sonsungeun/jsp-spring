...
<script type="text/javascript">
	...
	// 요청과 컨트롤러를 N:1 매칭하자
	function test1() {
		location.href="/0717_MVC02/Mycontoller?cmd=hi";
	}
	function test2() {
		location.href="/0717_MVC02/Mycontoller?cmd=hello";
	}
	function test3() {
		location.href="/0717_MVC02/Mycontoller?cmd=bye";
	}
	function send_go1(f) {
		f.action="/0717_MVC02/Mycontoller?cmd=hi";
		f.submit();
	}
	function send_go2(f) {
		f.action="/0717_MVC02/Mycontoller?cmd=hello";
		f.submit();
	}
	function send_go3(f) {
		f.action="/0717_MVC02/Mycontoller?cmd=bye";
		f.submit();
	}
</script>
</head>
