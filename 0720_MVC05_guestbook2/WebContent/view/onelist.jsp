...
<script type="text/javascript">
	function update_go(f) {
		f.action="/0720_MVC05_guestbook2/MyController?cmd=update";
		f.submit();
	}
	function delete_go(f) {
		f.action="/0720_MVC05_guestbook2/MyController?cmd=delete";
		f.submit();
	}
</script>
</head>
<body>
	<div align="center">
		<h2>방명록 : 상세화면</h2>
		<hr />
		<p>[<a href="/0720_MVC05_guestbook2/MyController?cmd=list">목록으로 이동</a>]</p>
		<form method="post">
			<table>
				<tr align="center">
